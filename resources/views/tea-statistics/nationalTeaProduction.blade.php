            ...
            <div class="page-header">
                <div class="container-fluid">
                    <form id="reportForm" data-action-after=2 data-validate=true method="POST" action="/manipulateNationTeaDescriptions">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="header-font1">National Tea Production</h1>
                                    ...
                                    <div class="link_section" id="link_section">
                                        <div class="add-link mb-40 pb-25" id="add-link">                                               
                                            <div class="comment-page-topic-section">
                                                ...
                                                <input class="form-control input-text1 header-font1 w-100" name="title" value="" placeholder="National Tea Production">
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="link_section" id="link_section">
                                        <div class="add-link mb-40 pb-25" id="add-link">                                               
                                            <div class="comment-page-topic-section">
                                                <label for="">Description Title</label>
                                                <input class="form-control input-text1 header-font1 w-100" name="title" value="{{$description->title}}" placeholder="National Tea Production">
                                            </div>
                        ...
                        <input type="hidden" name="type" value="NATIONAL_TEA_PRODUCTION">
                        @include('_GeneralComponents.formBottomNextPrevOnly', ['previous'=>'/monthly-tea-sales-average', 'next'=> '/sri-lanka-tea-production'])
