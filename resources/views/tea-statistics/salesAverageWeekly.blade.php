                    ...
                    <form id="reportForm" data-action-after=2 data-validate=true method="POST" action="/manipulatePublicSale">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-40">
                                ...
                                <input type="hidden" name="sale_type" value="WEEKLY">
                            </div>
                        </div>
                        ...
                        <div class="comment-first-section">                            
                            <div class="row">
                                <table class="table" id="link_section">
                                    <tr>
                                        <td></td>
                                        <td class="text-center" colspan="2">Weekly (LKR)</td>
                        ...
                        @include('_GeneralComponents.formBottomButtons', ['previous'=>'/national-tea-average', 'next'=> '/monthly-tea-sales-average'])
