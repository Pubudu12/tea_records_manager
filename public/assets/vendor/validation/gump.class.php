...
class GUMP
{
     ...
     *
     * @param bool   $localhostvert_to_string = false
     ...
     * @return string
     */
    public function get_readable_errors($localhostvert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        if (empty($this->errors)) {
            return ($localhostvert_to_string) ? null : array();
        }
     ...
     *
     * @param $localhostvert_to_string
     *
     * @return array | null (if empty)
     */
    public function get_errors_array($localhostvert_to_string = null)
    {
        if (empty($this->errors)) {
            return ($localhostvert_to_string) ? null : array();
        }
